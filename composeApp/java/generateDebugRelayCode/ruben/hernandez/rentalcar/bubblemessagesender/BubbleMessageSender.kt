package ruben.hernandez.rentalcar.bubblemessagesender
...
/**
 * This composable was generated from the UI Package 'bubble_message_sender'.
 * Generated code; do not edit directly
 */
@Composable
fun BubbleMessageSender(
...
@Composable
private fun BubbleMessageSenderPreview() {
    MaterialTheme {
        BubbleMessageSender(text = "I’d love to see you!")
    }
}
...
fun Vector(modifier: Modifier = Modifier) {
    RelayVector(
        vector = painterResource(R.drawable.bubble_message_sender_vector),
