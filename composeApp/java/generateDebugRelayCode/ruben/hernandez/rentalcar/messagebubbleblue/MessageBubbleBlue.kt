package ruben.hernandez.rentalcar.messagebubbleblue
...
/**
 * This composable was generated from the UI Package 'message_bubble_blue'.
 * Generated code; do not edit directly
 */
@Composable
fun MessageBubbleBlue(
        ...
        MessageBubble {
            MessageSendTime(modifier = Modifier.rowWeight(1.0f)) {
                BubbleTail(modifier = Modifier.rowWeight(1.0f)) {
                    BubbleTailSynth {
                        Bubble(modifier = Modifier.rowWeight(1.0f).columnWeight(1.0f)) {
                            Message(
                                text = text,
...
@Preview(widthDp = 267, heightDp = 56)
@Composable
private fun MessageBubbleBluePreview() {
    MaterialTheme {
        MessageBubbleBlue(text = "Let’s get lunch soon! When are you free? 🤗")
    }
}
...
fun BubbleTailSynth(
    ...
    RelayContainer(
        ...
        clipToParent = false,
        content = content,
        modifier = modifier.height(IntrinsicSize.Min).requiredWidth(267.0.dp).alpha(alpha = 100.0f)
    )
}
...
fun Vector(modifier: Modifier = Modifier) {
    RelayVector(
        vector = painterResource(R.drawable.message_bubble_blue_vector),
...
fun MessageBubble(
    ...
    RelayContainer(
        ...
        clipToParent = false,
        content = content,
        modifier = modifier.requiredWidth(267.0.dp)
    )
}
