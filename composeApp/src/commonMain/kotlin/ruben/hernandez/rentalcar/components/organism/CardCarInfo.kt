...
import ruben.hernandez.rentalcar.components.molecules.carInfoSeccion
            ...
            Column(
                ...
                AnimatedVisibility(
                    ...
                    Row(
                        ...
                        IconButton(
                            onClick = { corrutineScope.launch { sheetState.collapse() } },
                ...
                AnimatedVisibility(
                    ...
                    enter = slideInVertically(
                        initialOffsetY = { -600 },
                        animationSpec = tween(900)
                    ) + fadeIn(animationSpec = tween(900, delayMillis = 700))
                ) {
                    carInfoSeccion(
                        passengers,
                        transmission,
